...
#define SPI1_RESET RCC->APB2RSTR |= RCC_APB2RSTR_SPI1RST; RCC->APB2RSTR &= ~RCC_APB2RSTR_SPI1RST
#define SPI2_RESET RCC->APB1RSTR |= RCC_APB1RSTR_SPI2RST; RCC->APB1RSTR &= ~RCC_APB1RSTR_SPI2RST
#define SPI3_RESET RCC->APB1RSTR |= RCC_APB1RSTR_SPI3RST; RCC->APB1RSTR &= ~RCC_APB1RSTR_SPI3RST
#define SPI4_RESET RCC->APB2RSTR |= RCC_APB2RSTR_SPI4RST; RCC->APB2RSTR &= ~RCC_APB2RSTR_SPI4RST
